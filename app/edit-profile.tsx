  ...
  return (
    <KeyboardAvoidingView style={styles.screen} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <View style={styles.avatar}><Avatar label={name || 'M'} size={94} /><View style={styles.camera}><Ionicons name="camera-outline" size={17} color="white" /></View><Text style={styles.help}>Tap support will be added with real photo uploads.</Text></View>
        ...
        <View style={styles.username}><Text style={styles.usernameLabel}>Milo ID</Text><Text style={styles.usernameValue}>@{currentUser.username}</Text><Text style={styles.help}>Your username is managed separately.</Text></View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  camera: { width: 31, height: 31, borderRadius: 16, backgroundColor: colors.accent, alignItems: 'center', justifyContent: 'center', marginTop: -34, marginLeft: 67, borderWidth: 3, borderColor: colors.background },
