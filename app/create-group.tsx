    ...
    <SafeAreaView style={styles.screen}>
      ...
      {step === 1 ? <>
        ...
        <ScrollView contentContainerStyle={styles.details} keyboardShouldPersistTaps="handled">
          <Pressable style={styles.backStep} onPress={() => setStep(1)}><Ionicons name="arrow-back" size={18} color={colors.accent} /><Text style={styles.backText}>Change members</Text></Pressable>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.background }, progress: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: spacing.lg, paddingTop: 10 }, progressTrack: { flex: 1, height: 4, borderRadius: 2, backgroundColor: colors.line }, progressFill: { height: 4, borderRadius: 2, backgroundColor: colors.accent }, progressText: { color: colors.secondary, fontSize: 11 },
  ...
  check: { width: 24, height: 24, borderRadius: 12, borderWidth: 1.5, borderColor: colors.muted, alignItems: 'center', justifyContent: 'center' }, checkActive: { backgroundColor: colors.accent, borderColor: colors.accent },
  footer: { padding: spacing.lg, paddingBottom: 20, borderTopWidth: 1, borderTopColor: colors.line, backgroundColor: colors.surface }, details: { padding: spacing.lg, gap: 26, paddingBottom: 30 }, backStep: { flexDirection: 'row', alignItems: 'center', gap: 7 }, backText: { color: colors.accent, fontSize: 14, fontWeight: '600' },
  groupAvatar: { alignItems: 'center', gap: 9 }, groupCircle: { width: 88, height: 88, borderRadius: 28, backgroundColor: colors.accentSoft, alignItems: 'center', justifyContent: 'center' }, groupInitials: { color: colors.accent, fontSize: 26, fontWeight: '800' }, photoHint: { color: colors.secondary, fontSize: 12 },
