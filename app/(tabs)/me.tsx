  ...
  return (
    <SafeAreaView style={styles.screen}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.top}><Text style={styles.title}>Me</Text><Pressable accessibilityRole="button" accessibilityLabel="Open settings" onPress={() => router.push('/settings')}><Ionicons name="settings-outline" size={24} color={colors.text} /></Pressable></View>
        ...
        <View style={styles.actions}>
          ...
          <Action icon="finger-print-outline" label="Identity" onPress={() => router.push('/identity-wallet')} />
...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  action: { minHeight: 61, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: colors.line }, actionIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: colors.soft, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center' },
  ...
  overlay: { flex: 1, backgroundColor: colors.overlay, alignItems: 'center', justifyContent: 'center', padding: 26 }, qrCard: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, width: '100%', maxWidth: 360, padding: 24, borderRadius: 20, alignItems: 'center', gap: 17 },
  ...
  qr: { width: 216, height: 216, padding: 18, flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D8D8D8' }, pixel: { width: 20, height: 20 }, pixelOn: { backgroundColor: '#000000' },
});
